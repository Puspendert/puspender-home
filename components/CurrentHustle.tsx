...
function CurrentHustle() {
  return (
    <div className="relative rounded-lg bg-gradient-to-br from-[#0a1023] via-[#10172a] to-[#1a1333] shadow-xl border border-[#0a1023] flex items-center gap-4 overflow-hidden">
